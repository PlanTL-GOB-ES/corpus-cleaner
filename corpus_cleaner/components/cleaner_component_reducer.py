...
class LegacyCleanerComponentReducer(CleanerComponent):
...
class LegacyCleanerComponentReducer:

    def __init__(self, config: argparse.Namespace, format_: str, tmp_file: str, final_path: str,
                 input_path: Optional[str], extensions: Tuple[str]):
        super().__init__(args)
        self.format = format_
        self.tmp_file = tmp_file
